...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  private ActivitySplashScreenBinding(@NonNull RelativeLayout rootView,
      @NonNull RelativeLayout activitySplashScreen, @NonNull ImageView logo,
      @NonNull ProgressBar progresBar) {
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      RelativeLayout activitySplashScreen = (RelativeLayout) rootView;
      ...
      id = R.id.progresBar;
      ProgressBar progresBar = ViewBindings.findChildViewById(rootView, id);
      if (progresBar == null) {
        break missingId;
      }

      return new ActivitySplashScreenBinding((RelativeLayout) rootView, activitySplashScreen, logo,
          progresBar);
    }
